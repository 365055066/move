...
from brickmover.market.okex.rest.api  import Api
from brickmover.market.okex.rest.apifuture  import Apifuture
...
#现货API
okcoinSpot = Api(okcoinRESTURL,apikey,secretkey)

#期货API
okcoinFuture = Apifuture(okcoinRESTURL,apikey,secretkey)
